...
def students():
    ...
    with st.expander(
        ...
        if student_photo:
            ...
            photo_size_kb = (
                student_photo.size / 1024
            )

            if (
                photo_size_kb >= 10
                and photo_size_kb <= 200
            ):
    ...
    for student in student_data:
        ...
        with st.container(border=True):
            ...
            with st.expander(
                ...
                teacher_signature = st.file_uploader(
                    "Teacher Signature",
                    type=[
                        "jpg",
                        "jpeg",
                    ...
                    key=f"teacher_signature_{student_id}"
                )
                ...
                principal_signature = st.file_uploader(
                    ...
                    key=f"principal_signature_{student_id}"
                )
                ...
                if st.button(
                    ...
                    try:
                        ...
                        if teacher_signature:
                            ...
                            new_teacher_path = upload_student_file(
                                school_id,
                                student_id,
                                teacher_signature,
                                "teacher_signature",
                        ...
                        if principal_signature:
                            ...
                            new_principal_path = upload_student_file(
                                school_id,
                                student_id,
                                principal_signature,
                                "principal_signature",
...
def bulk_marks():
    ...
    exam_name = st.text_input(
        ...
        placeholder=(
            "Example: Unit Test 1, Half Yearly, Annual"
        ),
        key="marks_exam_name"
    ).strip()
    ...
    if not exam_name:
        ...
        st.info(
            "Enter the Exam / Assessment name to load students."
        )
...
def print_templates():
    ...
    st.markdown(
        ...
        **PDF, PNG, JPG, JPEG**
        ...
        These templates can later be used as the
        background/design for report cards, certificates,
        fee receipts and other printed documents.
        """
    )
    ...
    with st.expander(
        ...
        template_name = st.text_input(
            "Template Name",
            placeholder=(
                "Example: Annual Report Card 2026-27"
            ),
            key="template_name"
        )
