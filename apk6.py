            ...
            if subject_data:
                ...
                for subject in subject_data:
                    ...
                    with s1:
                        ...
                        st.write(
                            f"**{subject.get('subject_name')}**"
                        )

                        st.caption(
                            f"Maximum: "
                            f"{subject.get('max_marks')} | "
                            f"Passing: "
                            f"{subject.get('passing_marks')}"
                        )
                    ...
                    if st.session_state.get(
                        ...
                        with st.container(
                            ...
                            edit_subject_active = st.checkbox(
                                "Subject Active",
                                value=subject.get(
                                    "active",
                                    True
